...
#region const value
    ...
    private static readonly string LINES_BASE_NAME = "";
...
//        Debug.Log(m_LineList[m_LineList.Count - 1].name);

//        Debug.Log(m_LineList[m_LineList.Count - 1]);
