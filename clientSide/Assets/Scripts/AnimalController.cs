...
//                Debug.Log("Clear!");
 ...
 /*   void UpdateAnimals()
    ...
    public void InstantiateOffspring(Vector2 pos, string name, int gen, DNAstats a, DNAstats b, NeatNN nn_a, NeatNN nn_b, bool isHerbivore){
        ...
        if(isHerbivore){
            ...
            offspring.GetComponent<DNAstats>().CreateOffspringTraits(a, b,  mutationRate, maxMutationIntensity, percentOfIntenseMutations);
